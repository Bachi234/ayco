...
<section style="background-image: linear-gradient(to bottom right, red, orange);">
  <div class="container py-5">
    <h1 class="mt-4 mb-5" style="font-weight:900; color: white;"><strong>PC PARTS</strong></h1>
    ...
    <div class="row">
        ...
        <div class="card">
          ...
          <div class="card-body" style="background-color: rgba(175,155,155,.2);">
            <a href="" class="text-reset">
              <h5 class="card-title mb-3">MSI Gaming Force Trio RTX 3070ti</h5>
            </a>
            <a href="" class="text-reset">
              <p>PC BUILDS</p>
            </a>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card">
          ...
          <div class="card-body" style="background-color: rgba(175,155,155,.2);">
            <a href="" class="text-reset">
              <h5 class="card-title mb-3">Ryzen 5 5700x</h5>
            </a>
            <a href="" class="text-reset">
              <p>CPU</p>
            </a>
