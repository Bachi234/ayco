...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="img/shop_item/poster2.png" style="height: 500px;" class="d-block w-100" >
    </div>
    <div class="carousel-item">
      <img src="img/shop_item/poster3.png" style="height: 500px;" class="d-block w-100">
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card">
          <div class="bg-image hover-zoom ripple ripple-surface ripple-surface-light"
            data-mdb-ripple-color="light">
            <img src="img/shop_item/intel.png"
              class="w-100" style="height: 250px;"/>
            <a href="#!">
              <div class="mask">
                <div class="d-flex justify-content-start align-items-end h-100">
...
<!--Shop Card Start-->
<div class = "products" >
    <h1 class = "lg-title" style="font-weight:700;">PC Build Hub</h1>
        <div class = "product-collection">
            <div class = "container">
                <div class = "product-collection-wrapper">
                    <!-- product col left -->
                    <div class = "product-col-left flex" id="img-bg" style="background-image:url('img/poster/pcbuild.jpg');background-repeat:no-repeat;background-size:cover;border-radius:15px;
                    opacity:0.9;">
                        <div class = "product-col-content">
                            <h2 class = "sm-title" style="font-weight:600; color:black; text-shadow:4px 4px 4px white">Build PC </h2>
                            <h2 class = "md-title"style="font-weight:800; color:black; text-shadow:4px 4px 4px white">PC collection </h2>
                            <a href="product_shop.php"><button type = "button" class = "btn-dark">Shop now</button></a>
                        </div>
                    </div>

                    <!-- product col right -->
                    <div class = "product-col-right">
                        <div class = "product-col-r-top flex" style="background-image:url('img/poster/premium.png');background-repeat:no-repeat;background-size:cover;border-radius:15px;
                    opacity:0.9;">
                            <div class = "product-col-content">
                                <h2 class = "sm-title">Premium </h2>
                                <h2 class = "md-title">Premium Collection </h2>
                                <a href="product_shop_2.php"><button type = "button" class = "btn-dark">Shop now</button></a>
                            </div>
                        </div>

                        <div class = "product-col-right">
                            <!-- left -->
                            <div class = "product-col-r-top flex" style="background-image:url('img/poster/gaming.png');background-repeat:no-repeat;background-size:cover;border-radius:15px;
                    opacity:0.9;">
                                <div class = "product-col-content">
                                    <h2 class = "sm-title">Gaming sale </h2>
                                    <h2 class = "md-title">Extra 50% Off </h2>
                                    <a href="product_shop_3.php"><button type = "button" class = "btn-dark">Shop now</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
